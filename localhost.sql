...
SELECT YEAR(DATA_ZDARZ) as rok, COUNT(1) as zdarzenia FROM zdarzenie WHERE SZRD_KOD='04' AND CHMZ_KOD = '01' AND CONCAT_WS('/', WOJ, POWIAT) = 'WOJ. PODLASKIE/POWIAT BIAŁYSTOK' GROUP BY rok;
